...
use Helmich\TsParser\Tokenizer\TokenizerInterface,
    Helmich\TsParser\Tokenizer\Printer\TokenPrinterInterface;
...
class TokenizeCommand extends Command
{
     ...
     *
     * @internal
     * @param \Helmich\TsParser\Tokenizer\TokenizerInterface $tokenizer The tokenizer.
     * @return void
     */
     ...
     *
     * @internal
     * @param \Helmich\TsParser\Tokenizer\Printer\TokenPrinterInterface $tokenPrinter The token printer.
     * @return void
     */
