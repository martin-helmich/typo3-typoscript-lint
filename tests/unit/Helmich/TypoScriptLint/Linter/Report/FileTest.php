...
class FileTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $warning = $this->getMockBuilder('Helmich\TypoScriptLint\Linter\Report\Warning')->disableOriginalConstructor()->getMock();
    ...
    {
        $warningBuilder = $this->getMockBuilder('Helmich\TypoScriptLint\Linter\Report\Warning')->disableOriginalConstructor();
